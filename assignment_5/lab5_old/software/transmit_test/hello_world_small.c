...
#define parallel_out (volatile unsigned char *) 0x000050f0
#define parallel_in (volatile unsigned char *) 0x00005120
#define char_received (volatile unsigned char *) 0x0005110
#define char_sent (volatile unsigned char *) 0x000050d0
#define transmit_enable (volatile unsigned char *) 0x000050c0
#define load (volatile unsigned char *) 0x000050e0
