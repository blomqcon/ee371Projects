...
module test_mm_interconnect_0 (
	...
	wire  [91:0] cpu_jtag_debug_module_agent_rf_source_data;                                // cpu_jtag_debug_module_agent:rf_source_data -> cpu_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [91:0] cpu_jtag_debug_module_agent_rsp_fifo_out_data;                             // cpu_jtag_debug_module_agent_rsp_fifo:out_data -> cpu_jtag_debug_module_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_jtag_debug_module_agent:cp_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> led_pio_s1_agent:cp_data
	...
	wire  [14:0] switches_pio_s1_agent_m0_address;                                          // switches_pio_s1_agent:m0_address -> switches_pio_s1_translator:uav_address
	...
	wire  [91:0] switches_pio_s1_agent_rf_source_data;                                      // switches_pio_s1_agent:rf_source_data -> switches_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] switches_pio_s1_agent_rsp_fifo_out_data;                                   // switches_pio_s1_agent_rsp_fifo:out_data -> switches_pio_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> switches_pio_s1_agent:cp_data
	...
	wire  [90:0] cpu_jtag_debug_module_agent_rp_data;                                       // cpu_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] led_pio_s1_agent_rp_data;                                                  // led_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] switches_pio_s1_agent_rp_data;                                             // switches_pio_s1_agent:rp_data -> router_006:sink_data
	...
	wire         switches_pio_s1_agent_rdata_fifo_src_valid;                                // switches_pio_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] switches_pio_s1_agent_rdata_fifo_src_data;                                 // switches_pio_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         switches_pio_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_004:in_0_ready -> switches_pio_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> switches_pio_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> switches_pio_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                         // switches_pio_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> switches_pio_s1_agent:rdata_fifo_sink_error
