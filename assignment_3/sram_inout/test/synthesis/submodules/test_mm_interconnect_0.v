...
module test_mm_interconnect_0 (
	...
	wire   [8:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> onchip_mem_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> switches_pio_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> led_pio_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> sram_enable_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> sram_readwrite_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> sram_address_s1_agent:cp_channel
	...
	wire         cmd_mux_008_src_valid;                                                     // cmd_mux_008:src_valid -> sram_data_s1_agent:cp_valid
	wire  [91:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> sram_data_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // sram_data_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> sram_data_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                             // cmd_mux_008:src_startofpacket -> sram_data_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                               // cmd_mux_008:src_endofpacket -> sram_data_s1_agent:cp_endofpacket
	...
	wire         sram_data_s1_agent_rp_valid;                                               // sram_data_s1_agent:rp_valid -> router_010:sink_valid
	wire  [91:0] sram_data_s1_agent_rp_data;                                                // sram_data_s1_agent:rp_data -> router_010:sink_data
	wire         sram_data_s1_agent_rp_ready;                                               // router_010:sink_ready -> sram_data_s1_agent:rp_ready
	wire         sram_data_s1_agent_rp_startofpacket;                                       // sram_data_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         sram_data_s1_agent_rp_endofpacket;                                         // sram_data_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         sram_data_s1_agent_rdata_fifo_src_valid;                                   // sram_data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] sram_data_s1_agent_rdata_fifo_src_data;                                    // sram_data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         sram_data_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_008:in_0_ready -> sram_data_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                         // avalon_st_adapter_008:out_0_valid -> sram_data_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                          // avalon_st_adapter_008:out_0_data -> sram_data_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                         // sram_data_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                         // avalon_st_adapter_008:out_0_error -> sram_data_s1_agent:rdata_fifo_sink_error
